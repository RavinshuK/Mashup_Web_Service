...
def send_email(singer_name, receiver_email, file):
    ...
    password = "vaqzvnlrzkvnltkg"
    message["From"] = "ravinshukushwaha122@gmail.com"
    ...
    with smtplib.SMTP_SSL("smtp.gmail.com", 465, context=context) as server:
        server.login("ravinshukushwaha122@gmail.com", password)
        server.sendmail("ravinshukushwaha122@gmail.com", receiver_email, text)
